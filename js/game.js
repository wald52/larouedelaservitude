...
// variables de js/app.js, et disparaissait au moindre changement de page — un
// aller-retour vers « Données » remettait les 371 taxes en jeu, alors que
// « Données » est un onglet de l'application et non une sortie.
//
// `sessionStorage` et non `localStorage` : la partie appartient à l'onglet où
// elle se joue. Elle survit à une navigation et à un rechargement, et ne
// ressort pas d'elle-même une semaine plus tard, quand plus personne ne
// comprendrait pourquoi il manque des taxes sur la roue.
//
...
// Aucun accès au DOM ici, les deux documents peuvent donc l'importer.

import { GAME_KEY } from "./constants.js?v=2713e882";
