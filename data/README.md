...
- [`audit/redevances-eau-2026-09-02.json`](audit/redevances-eau-2026-09-02.json) reprend les lignes 35 à 39, ajoute les redevances créées ou maintenues par les réformes de 2025 et 2026, publie la redevance pour prélèvement sur la ressource en eau et conserve neuf créances bloquées faute de classement SEC individuel ;
- [`../docs/audit-prelevements-obligatoires-2026-lot-redevances-eau.md`](../docs/audit-prelevements-obligatoires-2026-lot-redevances-eau.md) documente la réforme de la facturation de l'eau, la ligne outre-mer agrégée, la nouvelle redevance PFAS et la non-ventilation des enveloppes statistique et budgétaire ;
- [`audit/hydroelectricite-chasse-2026-09-02.json`](audit/hydroelectricite-chasse-2026-09-02.json) reprend les lignes 31, 40 et 41, publie la redevance cynégétique de validation, scinde les régimes hydroélectriques et documente deux charges actives hors prélèvements obligatoires ;
- [`../docs/audit-prelevements-obligatoires-2026-lot-hydroelectricite-chasse.md`](../docs/audit-prelevements-obligatoires-2026-lot-hydroelectricite-chasse.md) explique la transition hydroélectrique du 1er septembre 2026, la non-attribution des enveloppes énergétiques, la distinction entre validation et délivrance du permis de chasser et l'exclusion de la redevance domaniale ;
- [`audit/navigation-maritime-2026-09-02.json`](audit/navigation-maritime-2026-09-02.json) fusionne les lignes 51 à 53 dans une fiche canonique prête à relire pour la taxe annuelle sur les engins maritimes à usage personnel, avec ses profils pavillon français, pavillon étranger et Corse ;
- [`../docs/audit-prelevements-obligatoires-2026-lot-navigation-maritime.md`](../docs/audit-prelevements-obligatoires-2026-lot-navigation-maritime.md) documente la table de concordance du DAFN et du passeport, le barème 2026, la recette NTL de 44 M€ et les changements applicables seulement en 2027 ;
- [`audit/permis-bateau-passagers-maritimes-2026-09-02.json`](audit/permis-bateau-passagers-maritimes-2026-09-02.json) scinde les lignes mixtes de transport aérien et maritime, documente la taxe sur les passagers vers les espaces naturels protégés et traite la taxe du permis bateau comme charge à contrepartie directe hors du périmètre retenu ;
- [`../docs/audit-prelevements-obligatoires-2026-lot-permis-bateau-passagers-maritimes.md`](../docs/audit-prelevements-obligatoires-2026-lot-permis-bateau-passagers-maritimes.md) explique la fin des composantes maritimes territoriales, la non-attribution de la ligne NTL 105, la prévision de 4,5 M€ pour les espaces protégés et l'exclusion méthodologique révisable du permis bateau ;
- [`audit/transport-aerien-2026-09-02.json`](audit/transport-aerien-2026-09-02.json) fusionne ou scinde six anciens libellés dans deux fiches canoniques prêtes à relire — taxe sur le transport aérien de passagers et taxe sur le transport aérien de marchandises — et conserve séparément les enveloppes NTL de 1 859 M€ et 47 M€ ;
- [`../docs/audit-prelevements-obligatoires-2026-lot-transport-aerien.md`](../docs/audit-prelevements-obligatoires-2026-lot-transport-aerien.md) documente les tarifs 2026, les majorations territoriales, le tarif nul de Paris-CDG, la scission de l'ancienne TAC et de la taxe d'aéroport, et la non-ventilation des recettes statistiques ;
- [`audit/transport-aerien-complement-2026-09-02.json`](audit/transport-aerien-complement-2026-09-02.json) résout la ligne 340 comme ancienne dénomination de la majoration outre-mer, corrige le champ de la taxe passagers, documente la TNSA comme candidate bloquée et exclut la redevance d'atterrissage pour contrepartie directe ;
- [`../docs/audit-prelevements-obligatoires-2026-lot-transport-aerien-complement.md`](../docs/audit-prelevements-obligatoires-2026-lot-transport-aerien-complement.md) explique la correspondance TEP-MOMTAP, les tarifs et coefficients de la TNSA, la non-attribution des 1 859 M€ et la nature non fiscale de la redevance d'atterrissage.
