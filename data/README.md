...
- [`audit/retraites-ruptures-2026-09-02.json`](audit/retraites-ruptures-2026-09-02.json) rassemble cinq fiches canoniques prêtes à relire — préretraite, trois contributions sur les retraites à prestations définies et contribution sur les indemnités de rupture ou de mise à la retraite — ainsi qu'un candidat RAVGDT encore bloqué ;
- [`../docs/audit-prelevements-obligatoires-2026-lot-retraites-ruptures.md`](../docs/audit-prelevements-obligatoires-2026-lot-retraites-ruptures.md) documente la scission de la ligne 14, la non-ventilation des enveloppes statistiques et budgétaires, et les preuves encore manquantes pour le RAVGDT.
